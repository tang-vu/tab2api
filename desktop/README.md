...
ChatGPT is deliberately opened in Playwright's dedicated Chromium window, never inside the system
WebView.
...
service process is stopped, preventing two processes from concurrently using the profile. Shutdown
