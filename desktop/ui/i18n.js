...
const en = {
  ...
  queueBody:
    'Pausing intake lets queued and in-flight turns finish before the service stops. Resume reopens intake.',
  ...
  drainQueue: 'Pause intake',
  resumeQueue: 'Resume',
  queuePausedStatus: 'Intake paused. Queued and in-flight turns will still finish.',
  queueResumedStatus: 'Intake resumed.',
  stopBusyTitle: 'Turns are still in progress',
  stopBusyBody:
    'Stopping now cuts off the queued or in-flight turns shown below. Pause intake on the queue card to let them finish first, or stop anyway.',
...
const managementTranslations = {
  vi: {
    ...
    queueTitle: 'Hàng đợi request',
    queueBody:
      'Tạm dừng nhận request để các lượt đang xếp và đang chạy hoàn tất trước khi dịch vụ dừng. Tiếp tục sẽ mở lại.',
    queuePending: 'Đang chờ',
    queueActive: 'Đang chạy',
    queueIntake: 'Nhận request',
    queueOpen: 'Đang mở',
    queuePaused: 'Đã tạm dừng',
    queueUnavailable: 'Không khả dụng',
    drainQueue: 'Tạm dừng nhận',
    resumeQueue: 'Tiếp tục',
    queuePausedStatus: 'Đã tạm dừng nhận request. Các lượt đang xếp và đang chạy vẫn sẽ hoàn tất.',
    queueResumedStatus: 'Đã mở lại nhận request.',
    stopBusyTitle: 'Vẫn còn lượt đang chạy',
    stopBusyBody:
      'Dừng ngay sẽ cắt các lượt đang xếp hoặc đang chạy bên dưới. Tạm dừng nhận request ở thẻ hàng đợi để chúng hoàn tất trước, hoặc dừng luôn.',
    stopAnyway: 'Dừng luôn',
  },
  zh: {
    adminTab: '密钥与用量',
    ...
    usageReset: '用量计数已重置。',
    queueTitle: '请求队列',
    queueBody: '暂停接收新请求，让队列中和进行中的轮次在服务停止前完成。恢复将重新开放接收。',
    queuePending: '排队中',
    queueActive: '进行中',
    queueIntake: '接收状态',
    queueOpen: '开放',
    queuePaused: '已暂停',
    queueUnavailable: '不可用',
    drainQueue: '暂停接收',
    resumeQueue: '恢复',
    queuePausedStatus: '已暂停接收。排队中和进行中的轮次仍会完成。',
    queueResumedStatus: '已恢复接收。',
    stopBusyTitle: '仍有轮次在进行',
    stopBusyBody:
      '立即停止会截断下方仍在排队或进行中的轮次。可先在队列卡片中暂停接收让其完成，或直接停止。',
    stopAnyway: '仍然停止',
  },
  ja: {
    adminTab: 'キーと使用量',
    ...
    queueTitle: 'リクエストキュー',
    queueBody:
      '取り込みを一時停止すると、キュー内および実行中のターンがサービス停止前に完了します。「再開」で取り込みを再開します。',
    queuePending: '待機中',
    queueActive: '実行中',
    queueIntake: '取り込み',
    queueOpen: 'オープン',
    queuePaused: '一時停止中',
    queueUnavailable: '利用不可',
    drainQueue: '取り込みを一時停止',
    resumeQueue: '再開',
    queuePausedStatus:
      '取り込みを一時停止しました。キュー内および実行中のターンは完了まで継続します。',
    queueResumedStatus: '取り込みを再開しました。',
    stopBusyTitle: 'ターンがまだ進行中です',
    stopBusyBody:
      '今すぐ停止すると、下記のキュー内または実行中のターンが中断されます。先にキューカードで取り込みを一時停止して完了を待つか、そのまま停止してください。',
    stopAnyway: 'それでも停止',
  },
  ko: {
    adminTab: '키 및 사용량',
    ...
    queueTitle: '요청 큐',
    queueBody:
      '수신을 일시 중지하면 큐에 있는 턴과 진행 중인 턴이 서비스 중지 전에 완료됩니다. 재개하면 수신이 다시 열립니다.',
    queuePending: '대기 중',
    queueActive: '진행 중',
    queueIntake: '수신',
    queueOpen: '열림',
    queuePaused: '일시 중지됨',
    queueUnavailable: '사용할 수 없음',
    drainQueue: '수신 일시 중지',
    resumeQueue: '재개',
    queuePausedStatus: '수신이 일시 중지되었습니다. 큐에 있는 턴과 진행 중인 턴은 계속 완료됩니다.',
    queueResumedStatus: '수신을 재개했습니다.',
    stopBusyTitle: '아직 진행 중인 턴이 있습니다',
    stopBusyBody:
      '지금 중지하면 아래 큐에 있거나 진행 중인 턴이 끊깁니다. 큐 카드에서 수신을 일시 중지해 완료를 기다리거나, 그대로 중지하세요.',
    stopAnyway: '그래도 중지',
  },
  es: {
    ...
    queueTitle: 'Cola de solicitudes',
    queueBody:
      'Pausar la admisión permite que los turnos en cola y en curso terminen antes de detener el servicio. Reanudar la vuelve a abrir.',
    queuePending: 'Pendientes',
    queueActive: 'Activos',
    queueIntake: 'Admisión',
    queueOpen: 'Abierta',
    queuePaused: 'Pausada',
    queueUnavailable: 'No disponible',
    drainQueue: 'Pausar admisión',
    resumeQueue: 'Reanudar',
    queuePausedStatus: 'Admisión en pausa. Los turnos en cola y en curso seguirán hasta terminar.',
    queueResumedStatus: 'Admisión reanudada.',
    stopBusyTitle: 'Aún hay turnos en curso',
    stopBusyBody:
      'Detener ahora cortará los turnos en cola o en curso indicados abajo. Pausa la admisión en la tarjeta de cola para que terminen, o detén igualmente.',
    stopAnyway: 'Detener igualmente',
  },
  fr: {
    ...
    queueTitle: 'File de requêtes',
    queueBody:
      'Suspendre l’admission permet aux tours en file et en cours de se terminer avant l’arrêt du service. Reprendre la rouvre.',
    queuePending: 'En attente',
    queueActive: 'Actifs',
    queueIntake: 'Admission',
    queueOpen: 'Ouverte',
    queuePaused: 'Suspendue',
    queueUnavailable: 'Indisponible',
    drainQueue: 'Suspendre l’admission',
    resumeQueue: 'Reprendre',
    queuePausedStatus: 'Admission suspendue. Les tours en file et en cours iront jusqu’à leur fin.',
    queueResumedStatus: 'Admission reprise.',
    stopBusyTitle: 'Des tours sont encore en cours',
    stopBusyBody:
      'Arrêter maintenant interrompra les tours en file ou en cours indiqués ci-dessous. Suspendez l’admission dans la carte de file pour les laisser finir, ou arrêtez quand même.',
    stopAnyway: 'Arrêter quand même',
  },
  de: {
    ...
    queueTitle: 'Anfrage-Warteschlange',
    queueBody:
      'Pausiert die Aufnahme, damit wartende und laufende Züge vor dem Dienst-Stopp zu Ende laufen. Fortsetzen öffnet die Aufnahme wieder.',
    queuePending: 'Wartend',
    queueActive: 'Aktiv',
    queueIntake: 'Aufnahme',
    queueOpen: 'Offen',
    queuePaused: 'Pausiert',
    queueUnavailable: 'Nicht verfügbar',
    drainQueue: 'Aufnahme pausieren',
    resumeQueue: 'Fortsetzen',
    queuePausedStatus: 'Aufnahme pausiert. Wartende und laufende Züge laufen noch zu Ende.',
    queueResumedStatus: 'Aufnahme fortgesetzt.',
    stopBusyTitle: 'Züge laufen noch',
    stopBusyBody:
      'Ein sofortiger Stopp bricht die unten gezeigten wartenden oder laufenden Züge ab. Pausiere die Aufnahme in der Warteschlangen-Karte, bis sie fertig sind, oder stoppe trotzdem.',
